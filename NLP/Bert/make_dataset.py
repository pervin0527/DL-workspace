...
if __name__ == '__main__':
    ...
    parser.add_argument("--input", default="./data/kowiki/kowiki.txt", type=str, required=False, help="input text file")
    parser.add_argument("--output", default="./data/kowiki/kowiki_bert_{}.json", type=str, required=False, help="output json file")
