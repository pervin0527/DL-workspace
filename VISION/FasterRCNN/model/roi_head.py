...
from model.bbox_utils import box_iou, Matcher, BalancedPositiveNegativeSampler, BoxCoder, clip_boxes_to_image, remove_small_boxes, batched_nms, smooth_l1_loss
...
class RoIHeads(torch.nn.Module):
    def __init__(self,
        ...
        self.proposal_matcher = Matcher(fg_iou_thresh,  # 0.5
                                        bg_iou_thresh,  # 0.5
