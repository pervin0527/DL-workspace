...
class Yolov1(nn.Module):
    def __init__(self, in_channels=3, grid_size=7, num_boxes=2, num_classes=20):
        ...
        self.darknet = self.build_darknet(self.in_channels)
        self.head = self.build_head(grid_size, num_boxes, num_classes)
    ...
    def build_darknet(self, in_channels):
        ...
        layers.extend([CNNBlock(512, 512, kernel_size=1, stride=1, padding=0),
        ...
        layers.extend([CNNBlock(1024, 1024, kernel_size=3, stride=1, padding=1),
...
if __name__ == "__main__":
    ...
    model = model = Yolov1(grid_size=7, num_boxes=2, num_classes=20)
