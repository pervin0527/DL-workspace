...
def intersection_over_union(boxes_preds, boxes_labels, box_format="midpoint"):
    if box_format == "midpoint":
        box1_x1 = boxes_preds[..., 0:1] - boxes_preds[..., 2:3] / 2 ## 전체 row에서 x column만 slicing.
        box1_y1 = boxes_preds[..., 1:2] - boxes_preds[..., 3:4] / 2 ## 전체 row에서 y column만 slicing.
    ...
    if box_format == "corners":
        box1_x1 = boxes_preds[..., 0:1] ## xmin
        box1_y1 = boxes_preds[..., 1:2] ## ymin

        box1_x2 = boxes_preds[..., 2:3] ## max
        box1_y2 = boxes_preds[..., 3:4] ## xmax
