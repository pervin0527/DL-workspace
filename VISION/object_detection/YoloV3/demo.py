...
parser.add_argument("--image_folder", type=str, default="/home/pervinco/Desktop/yolov3-pytorch/data/voc_test", help="path to image folder")
parser.add_argument("--save_folder", type=str, default='/home/pervinco/Desktop/yolov3-pytorch/data/results', help='path to saving result folder')
parser.add_argument("--batch_size", type=int, default=1, help="size of the batches")
parser.add_argument("--num_workers", type=int, default=8, help="number of cpu threads to use during batch generation")
parser.add_argument("--data_config", type=str, default="config/voc.data", help="path to data config file")
parser.add_argument("--pretrained_weights", type=str, default="/home/pervinco/Desktop/yolov3-pytorch/checkpoints/240108_231700/yolov3_voc_14.pth", help="path to pretrained weights file")
