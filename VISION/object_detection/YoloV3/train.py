...
dataset = YoloDataset(train_path, img_size=args.image_size, augment=True, multiscale=args.multiscale_training)
dataloader = DataLoader(dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, pin_memory=True, collate_fn=dataset.collate_fn)
