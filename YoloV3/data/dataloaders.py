...
from data.augmentations import Albumentations, mixup, letterbox, xywhn2xyxy, random_perspective, augment_hsv, copy_paste
from data.utils import get_hash, img2label_paths, verify_image_label, xywhn2xyxy, xyxy2xywhn, xyn2xy, seed_worker
    ...
    def __init__(self,
        ...
        try:
            ...
            for p in path if isinstance(path, list) else [path]:
                ...
                if p.is_dir():  # dir
                    f += glob(str(p / 'images' / '*.*'), recursive=True)
